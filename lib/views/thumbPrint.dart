...
class ThumbPrint extends StatefulWidget {
  final String title;
  ...
  @override
  State<ThumbPrint> createState() => _ThumbPrintState();
}

class _ThumbPrintState extends State<ThumbPrint> {
  ...
  void initState() {
    super.initState();
     final config = FingerprintConfig(
      ...
      captureType: FingerprintCaptureType.thumbs,
