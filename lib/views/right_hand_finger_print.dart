...
class RightHandFinger extends StatefulWidget {
  final String title;
  ...
  @override
  State<RightHandFinger> createState() => _RightHandFingerState();
}

class _RightHandFingerState extends State<RightHandFinger> {
  ...
  void initState() {
    super.initState();
     final config = FingerprintConfig(
      ...
      captureType: FingerprintCaptureType.rightHandFingers,
...
//             fingerprintFrontImage: capturedFingerprints[i][1],
//             onDeletePressed: (){},
//             onUploadPressed: (){},
//             context: context,
//           ),
